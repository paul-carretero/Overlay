...
public class NodeMQ implements Consumer
{
	 ...
	 * @param matrixLine Le tableau permettant de conna�tre les voisins � lier avec le noeud courant
	 */
	...
	/**
	 * Ajoute deux queues de communication (bidirectionnel) entre le noeud courant et le noeud identifi�, donn� en argument
	 * @param id L'identifiant du noeud NodeMQ � ajouter en voisin
	 */
	...
	/**
	 * Ajoute un �couteur d'ev�nement de reception de message dans la liste (pattern observer)
	...
	/**
	 * Envoi un message sur une queue donn�e
	 * @param queue La queue de communication � utiliser
